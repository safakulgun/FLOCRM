#Veri Hazırlam
           # 1. flo_data_20K.csv verisini okuyunuz.Dataframe’in kopyasını oluşturalım
           ...
           # 5. Değişken tiplerini inceleyerek tarih ifade eden değişkenlerin tipini date'e çevirelim.
...
# Monetary değeri satın alma başına ortalama değer olarak, recency ve tenure değerleri ise haftalık cinsten ifade edelim.
...
# 2. Gamma-Gamma modelini fit ederek. Müşterilerin ortalama bırakacakları değeri tahminleyip exp_average_value olarak cltv dataframe'ine ekleyelim.
# 3. 6 aylık CLTV hesaplayalım ve cltv ismiyle dataframe'e ekleyelim
# a. Hesapladığınız cltv değerlerini standarlaştırıp scaled_cltv değişkeni oluşturalım
...
# 2. Gamma-Gamma modelini fit ederek. Müşterilerin ortalama bırakacakları değeri tahminleyip
# exp_average_value olarak cltv dataframe'ine ekleyelim.
...
# 1. 6 aylık standartlaştırılmış CLTV'ye göre tüm müşterilerinizi 4 gruba (segmente) ayıralım ve grup isimlerini veri setine ekleyelim. cltv_segment ismi ile dataframe'e ekleyelim.
